...
const Footer = () => {
    return (
       ...
       <Link href="/about"> <p className="footer-des"> <FcAbout className="footer-icons"/>About Us</p></Link>
        <Link href="/contact"> <p  className="footer-des"><BsPhone className="footer-icons"/>Contact Us</p></Link>
        <Link href="/services" ><p className="footer-des"><GrServices className="footer-icons"/>Services Us</p></Link>
        </div>
